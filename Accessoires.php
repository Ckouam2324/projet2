  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-md-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="http://localhost:8888/wordpress3/panierpanier/">Panier</a>
        </li>
      </ul>
    </div>
  </nav>
  ...
  <div class="row mb-4">
    <div class="col-12">
      ...
      <p class="text-center">
        ...
        $category_id = get_term_by('slug', 'Accessoires', 'product_cat')->term_id;
  ...
  <div class="row">
    ...
    <div class="col-md-3 mb-4">
      <div class="bg-light p-3 rounded">
        ...
        echo do_shortcode('[tf_product_filter id="filtrer"]');
        ?>
      </div>
    </div>
